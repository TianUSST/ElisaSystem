...
class SwinBlock(nn.Module):
    def __init__(self, dims, ip_res, ss_size = 3,window_size = 8):
        super().__init__()
        self.swtb1 = SwinTransformerBlock(dim=dims, input_resolution=ip_res,window_size=window_size)
        self.swtb2 = SwinTransformerBlock(dim=dims, input_resolution=ip_res, shift_size=ss_size,window_size=window_size)
